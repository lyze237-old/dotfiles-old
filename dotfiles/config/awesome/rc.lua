...
awful.tag({ "", "", "", "4", "5", "", "", "", "" }, 1, 
    {layouts[1], layouts[1], layouts[1], layouts[1], layouts[1], layouts[6], layouts[1], layouts[5], layouts[1]}
)
...
globalkeys = awful.util.table.join(
    ...
    -- sink
    awful.key({ }, "Pause", function() awful.spawn(os.getenv("HOME") .. "/.config/awesome/scripts/defaultSink.py") end,
    ...
    awful.key({modkey}, "Print", function() awful.util.spawn("flameshot gui", false)end ,
        {description = "Screenshot with gui", group = "launcher"}),
